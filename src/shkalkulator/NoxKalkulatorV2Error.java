...
/**
     ...
     * 
     * link tutor v2:
     * https://kindsonthegenius.com/blog/part-2-how-to-build-a-simple-calculator-in-java-using-netbeans-step-by-step-with-screenshots/
     * 
     */
public class NoxKalkulatorV2Error extends javax.swing.JFrame {
    String res, signh="";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Kalkulator Anti Mumet v2");
    ...
    private void NoxBt9_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NoxBt9_ActionPerformed
        ...
        if (NoxLayar_.getText().isEmpty()){
            ...
            NoxLayar_.setText(NoxLayar_.getText() + "9");
            Nilai2 = Integer.parseInt(Nilai2 + "9");
        }
        else {
            NoxLayar_.setText(NoxLayar_.getText()+ "9");
        }
    ...
    private void NoxBt6_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NoxBt6_ActionPerformed
        ...
        if (NoxLayar_.getText().isEmpty()){
            NoxLayar_.setText("6");
                ...
                res.contains("*") || res.contains("/")){
            NoxLayar_.setText(NoxLayar_.getText() + "6");
            Nilai2 = Integer.parseInt(Nilai2 + "6");
        }
        else {
            NoxLayar_.setText(NoxLayar_.getText()+ "6");
        }
    ...
    private void NoxBt5_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NoxBt5_ActionPerformed
        ...
        if (NoxLayar_.getText().isEmpty()){
            NoxLayar_.setText("5");
                ...
                res.contains("*") || res.contains("/")){
            NoxLayar_.setText(NoxLayar_.getText() + "5");
            Nilai2 = Integer.parseInt(Nilai2 + "5");
        }
        else {
            NoxLayar_.setText(NoxLayar_.getText()+ "5");
        }
    ...
    private void NoxBt2_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NoxBt2_ActionPerformed
        ...
        if (NoxLayar_.getText().isEmpty()){
            NoxLayar_.setText("2");
                ...
                res.contains("*") || res.contains("/")){
            NoxLayar_.setText(NoxLayar_.getText() + "2");
            Nilai2 = Integer.parseInt(Nilai2 + "2");
        }
        else {
            NoxLayar_.setText(NoxLayar_.getText()+ "2");
        }
    ...
    private void NoxBt3_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NoxBt3_ActionPerformed
        ...
        if (NoxLayar_.getText().isEmpty()){
            NoxLayar_.setText("3");
                ...
                res.contains("*") || res.contains("/")){
            NoxLayar_.setText(NoxLayar_.getText() + "3");
            Nilai2 = Integer.parseInt(Nilai2 + "3");
        }
        else {
            NoxLayar_.setText(NoxLayar_.getText()+ "3");
        }
    ...
    private void NoxBtTambah_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NoxBtTambah_ActionPerformed
        ...
        if (NoxLayar_.getText().isEmpty()){
            ...
            Nilai1 = Integer.parseInt(NoxLayar_.getText());
            NoxLayar_.setText(NoxLayar_.getText() + "" + NoxBtTambah_.getText());
            OperatorMTK = "tambah";
        }
    ...
    private void NoxBtKurang_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NoxBtKurang_ActionPerformed
        ...
        if (NoxLayar_.getText().isEmpty()){
            ...
            Nilai1 = Integer.parseInt(NoxLayar_.getText());
            NoxLayar_.setText(NoxLayar_.getText() + "" + NoxBtKurang_.getText());
            OperatorMTK = "kurang";
        }
    ...
    private void NoxBtKali_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NoxBtKali_ActionPerformed
        ...
        if (NoxLayar_.getText().isEmpty()){
            ...
            Nilai1 = Integer.parseInt(NoxLayar_.getText());
            NoxLayar_.setText(NoxLayar_.getText() + "" + NoxBtKali_.getText());
    ...
    private void NoxBtBagi_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NoxBtBagi_ActionPerformed
        ...
        if (NoxLayar_.getText().isEmpty()){
            ...
            Nilai1 = Integer.parseInt(NoxLayar_.getText());
            NoxLayar_.setText(NoxLayar_.getText() + "" + NoxBtBagi_.getText());
    ...
    private void NoxBt7_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NoxBt7_ActionPerformed
        ...
        if (NoxLayar_.getText().isEmpty()){
            NoxLayar_.setText("7");
                ...
                res.contains("*") || res.contains("/")){
            NoxLayar_.setText(NoxLayar_.getText() + "7");
            Nilai2 = Integer.parseInt(Nilai2 + "7");
        }
        else {
            NoxLayar_.setText(NoxLayar_.getText()+ "7");
        }
    ...
    private void NoxBt8_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NoxBt8_ActionPerformed
        ...
        if (NoxLayar_.getText().isEmpty()){
            NoxLayar_.setText("8");
                ...
                res.contains("*") || res.contains("/")){
            NoxLayar_.setText(NoxLayar_.getText() + "8");
            Nilai2 = Integer.parseInt(Nilai2 + "8");
        }
        else {
            NoxLayar_.setText(NoxLayar_.getText()+ "8");
        }
    ...
    private void NoxBt4_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NoxBt4_ActionPerformed
        ...
        if (NoxLayar_.getText().isEmpty()){
            NoxLayar_.setText("4");
                ...
                res.contains("*") || res.contains("/")){
            NoxLayar_.setText(NoxLayar_.getText() + "4");
            Nilai2 = Integer.parseInt(Nilai2 + "4");
        }
        else {
            NoxLayar_.setText(NoxLayar_.getText()+ "4");
        }
    ...
    private void NoxBt1_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NoxBt1_ActionPerformed
        ...
        if (NoxLayar_.getText().isEmpty()){
            NoxLayar_.setText("1");
                ...
                res.contains("*") || res.contains("/")){
            NoxLayar_.setText(NoxLayar_.getText() + "1");
            Nilai2 = Integer.parseInt(Nilai2 + "1");
        }
        else {
            NoxLayar_.setText(NoxLayar_.getText()+ "1");
        }
    ...
    private void NoxBt0_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NoxBt0_ActionPerformed
        ...
        if (NoxLayar_.getText().isEmpty()){
            NoxLayar_.setText("0");
                ...
                res.contains("*") || res.contains("/")){
            NoxLayar_.setText(NoxLayar_.getText() + "0");
            Nilai2 = Integer.parseInt(Nilai2 + "0");
        }
        else {
            NoxLayar_.setText(NoxLayar_.getText()+ "0");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NoxKalkulatorV2Error.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NoxKalkulatorV2Error().setVisible(true);
            }
        });
    }
