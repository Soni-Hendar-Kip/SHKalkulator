...
/**
     ...
     * 
     */
public class NoxKalkulatorVersiGoogle1 extends javax.swing.JFrame {
    String signh="";
     ...
     */
    public NoxKalkulatorVersiGoogle1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NoxKalkulatorVersiGoogle1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NoxKalkulatorVersiGoogle1().setVisible(true);
            }
        });
    }
